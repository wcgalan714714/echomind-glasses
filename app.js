...
function renderInsights() {
    ...
    getInsights().forEach(insight => {
        ...
        // Tap to start Yes/No/Maybe flow (in-place)
        card.onclick = () => startConversation(card, insight);
        panel.appendChild(card);
    });
}

// In-place conversation (other cards stay visible)
function startConversation(cardElement, insight) {
